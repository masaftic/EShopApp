...
namespace EShopApp.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250121091916_Relations_inventory_reservation")]
    partial class Relations_inventory_reservation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EShopApp.Domain.Entities.Reservation", b =>
                {
                    b.HasOne("EShopApp.Infrastructure.Data.Identity.ApplicationUser", null)
                        .WithOne()
                        .HasForeignKey("EShopApp.Domain.Entities.Reservation", "UserId")
